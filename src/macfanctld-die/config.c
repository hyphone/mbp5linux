...
float temp_TG0D_floor = 40;
float temp_TG0D_ceiling = 50;

float temp_TN0D_floor = 40;
float temp_TN0D_ceiling = 50;
...
void read_cfg(char* name)
{
	...
	if(fp != NULL)
	{
		...
		temp_TG0D_ceiling = read_param("temp_TG0D_ceiling",	0, 90, 80);
		temp_TG0D_floor = read_param("temp_TG0D_floor",		0, temp_TG0D_ceiling - 1, 65);

		temp_TN0D_ceiling = read_param("temp_TN0D_ceiling",	0, 90, 80);
		temp_TN0D_floor = read_param("temp_TN0D_floor",		0, temp_TN0D_ceiling - 1, 65);
	...
	printf("\ttemp_TN0D_floor: %.0f\n", temp_TN0D_floor);
	printf("\ttemp_TN0D_ceiling: %.0f\n", temp_TN0D_ceiling);
